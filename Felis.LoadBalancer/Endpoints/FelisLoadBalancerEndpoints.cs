...
namespace Felis.LoadBalancer.Endpoints;

internal static class FelisLoadBalancerEndpoints
{
    public static void MapFelisLoadBalancerEndpoints(this IEndpointRouteBuilder endpointRouteBuilder)
    {
