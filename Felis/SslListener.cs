...
internal class SslListener
{
    ...
    private async Task HandleClientAsync(Socket socket)
    {
        ...
        var subscription = new SubscriptionModel(clientId, "host", "ip",
            new DateTimeOffset(DateTime.UtcNow).ToUnixTimeMilliseconds(), true);
        ...
        try
        {
            ...
            _clients[subscription] = sslStream;
        ...
        {
            _clients.TryRemove(subscription, out _);
            socket.Dispose();
